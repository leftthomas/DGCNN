...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_size', default=48, type=int, help='training images input size')
    ...
    train_loss_logger = VisdomPlotLogger('line', env=str(UPSCALE_FACTOR), opts={'title': 'Train Loss'})
    val_loss_logger = VisdomPlotLogger('line', env=str(UPSCALE_FACTOR), opts={'title': 'Val Loss'})
    train_psnr_logger = VisdomPlotLogger('line', env=str(UPSCALE_FACTOR), opts={'title': 'Train PSNR'})
    val_psnr_logger = VisdomPlotLogger('line', env=str(UPSCALE_FACTOR), opts={'title': 'Val PSNR'})
    train_ssim_logger = VisdomPlotLogger('line', env=str(UPSCALE_FACTOR), opts={'title': 'Train SSIM'})
    val_ssim_logger = VisdomPlotLogger('line', env=str(UPSCALE_FACTOR), opts={'title': 'Val SSIM'})
