...
if __name__ == '__main__':
    ...
    test_real_set = TestDatasetFromFolder(TEST_PATH, crop_size=640, data_type='real')
    test_synthetic_set = TestDatasetFromFolder(TEST_PATH, crop_size=640, data_type='synthetic')
