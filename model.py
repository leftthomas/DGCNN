...
class Model(nn.Module):
    def __init__(self, upscale_factor=2):
        ...
        self.block2 = CapsuleConv2d(64, 64, 3, 4, 8, padding=1, similarity='tonimoto')
        self.block3 = CapsuleConv2d(64, 64, 3, 8, 8, padding=1, similarity='tonimoto')
        self.block4 = CapsuleConv2d(64, 64, 3, 8, 16, padding=1, similarity='tonimoto')
        self.block5 = CapsuleConv2d(64, 64, 3, 16, 16, padding=1, similarity='tonimoto')
        self.block6 = CapsuleConv2d(64, 64, 3, 16, 8, padding=1, similarity='tonimoto')
        self.block7 = CapsuleConv2d(64, 64, 3, 8, 8, padding=1, similarity='tonimoto')
        self.block8 = CapsuleConv2d(64, 64, 3, 8, 4, padding=1, similarity='tonimoto')
